...
Config.defaultList = {
    ...
    {
        label = "Chillout Lounge Live Radio",
        url = "https://www.youtube.com/watch?v=9UMxZofMNbA",
    },
    {
        label = "juice wrld radio ❤️ 24/7 live stream",
        url = "https://www.youtube.com/watch?v=ns33BLVqZ5w",
    },
    {
        label = "Rap Live Radio",
